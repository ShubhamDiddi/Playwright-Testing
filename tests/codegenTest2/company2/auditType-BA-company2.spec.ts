...
test('test', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: 'Area' }).fill('C2_CCSA_BA1');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active', exact: true }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('textbox', { name: 'Area' }).fill('C2_CCSA_BA2');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active', exact: true }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    // ---------------------- CREATE SUBAREAS ----------------------
    ...
    await page.getByRole('option', { name: 'C2_CCSA_BA1' }).click();
    await page.getByRole('textbox', { name: 'Subarea' }).fill('C2_CCSA_BA1_SA1');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active', exact: true }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('combobox', { name: 'Area' }).click();
    await page.getByRole('option', { name: 'C2_CCSA_BA1' }).click();
    await page.getByRole('textbox', { name: 'Subarea' }).fill('C2_CCSA_BA1_SA2');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active', exact: true }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('combobox', { name: 'Area' }).click();
    await page.getByRole('option', { name: 'C2_CCSA_BA2' }).click();
    await page.getByRole('textbox', { name: 'Subarea' }).fill('C2_CCSA_BA2_SA1');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active', exact: true }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    // ---------------------- CREATE QUESTIONS ----------------------
    ...
    await page.getByRole('option', { name: 'C2_CCSA_BA1_SA1' }).click();
    await page.getByRole('textbox', { name: 'Question' }).fill('C2_CCSA_BA1_SA1 QUESTION1');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active' }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('textbox', { name: 'Question' }).fill('C2_CCSA_BA1_SA1 QUESTION2');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active' }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('combobox', { name: 'Subarea' }).click();
    await page.getByRole('option', { name: 'C2_CCSA_BA1_SA2' }).click();
    await page.getByRole('textbox', { name: 'Question' }).fill('C2_CCSA_BA1_SA2 QUESTION');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active' }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('combobox', { name: 'Area' }).click();
    await page.getByRole('option', { name: 'C2_CCSA_BA2' }).click();
    await page.getByRole('combobox', { name: 'Subarea' }).click();
    await page.getByRole('option', { name: 'C2_CCSA_BA2_SA1' }).click();
    await page.getByRole('textbox', { name: 'Question' }).fill('C2_CCSA_BA2_SA1 QUESTION');
    await page.getByRole('combobox', { name: 'Status' }).click();
    await page.getByRole('option', { name: 'Active' }).click();
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('menuitem', { name: 'Admin' }).click();
    ...
    await page.getByRole('option', { name: 'C2_CCSA_BA1_SA1 QUESTION1' }).click();
    await page.getByRole('textbox', { name: 'Document Name' }).fill('C2_CCSA_AuditLevelDocument1');
    ...
    await page.getByRole('button', { name: 'Choose File' }).setInputFiles('C2_CCSA_AuditLevelDocument1.xlsx');
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('textbox', { name: 'Document Name' }).fill('C2_CCSA_AuditorDocument');
    await page.getByRole('combobox', { name: 'Category' }).click();
    await page.getByRole('option', { name: 'AUDITOR' }).click();
    await page.getByRole('combobox', { name: 'Document Type' }).click();
    await page.getByRole('option', { name: 'Supporting' }).click();
    await page.getByRole('button', { name: 'Choose File' }).setInputFiles('C2_CCSA_AuditorDocument.pdf');
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('textbox', { name: 'Document Name' }).fill('C2_CCSA_AuditLevelDocument2');
    await page.getByRole('combobox', { name: 'Category' }).click();
    await page.getByRole('option', { name: 'AUDITOR' }).click();
    await page.getByRole('combobox', { name: 'Document Type' }).click();
    await page.getByRole('option', { name: 'Annexure' }).click();
    await page.getByRole('button', { name: 'Choose File' }).setInputFiles('C2_CCSA_AuditLevelDocument2.xlsx');
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('combobox', { name: 'Subarea' }).click();
    await page.getByRole('option', { name: 'C2_CCSA_BA1_SA2' }).click();
    await page.getByRole('combobox', { name: 'Question' }).click();
    await page.getByRole('option', { name: 'C2_CCSA_BA1_SA2 QUESTION' }).click();
    await page.getByRole('textbox', { name: 'Document Name' }).fill('C1_CCSA_AuditeeDocument');
    await page.getByRole('combobox', { name: 'Category' }).click();
    await page.getByRole('option', { name: 'AUDITEE' }).click();
    await page.getByRole('combobox', { name: 'Document Type' }).click();
    await page.getByRole('option', { name: 'Supporting' }).click();
    await page.getByRole('button', { name: 'Choose File' }).setInputFiles('C1_CCSA_AuditeeDocument.pdf');
    await page.getByRole('button', { name: 'Submit' }).click();
    // -------------Create Audit Type-----------------
    await page.getByRole('menuitem', { name: 'Admin' }).click();
    ...
    await page.getByRole('textbox', { name: 'Audit Type Name' }).fill('C2 Concurrent Simple');
    await page.getByRole('combobox', { name: 'Audit Type Status' }).click();
    await page.getByRole('option', { name: 'ACTIVE', exact: true }).click();
    await page.getByRole('combobox', { name: 'Audit Scoring Method' }).click();
    await page.getByRole('option', { name: 'Simple Average' }).click();
    ...
    await page.getByRole('textbox', { name: 'Description' }).fill('This is the C2 concurrent simple audit type.');
    ...
    await page.getByRole('option', { name: 'C2 Concurrent Simple' }).click();
    await page.getByRole('checkbox', { name: 'C2 Delhi HO' }).check();
    await page.getByRole('button', { name: 'move selected right' }).first().click();
    await page.getByRole('checkbox', { name: 'C2_CCSA_BA1' }).check();
    await page.getByRole('checkbox', { name: 'C2_CCSA_BA2' }).check();
    ...
    await page.getByRole('combobox').nth(1).click();
    await page.getByRole('option', { name: 'C2 Concurrent Simple' }).click();
    await page.getByRole('checkbox', { name: 'C2 Chennai Branch' }).check();
    await page.getByRole('button', { name: 'move selected right' }).first().click();
    await page.getByRole('checkbox', { name: 'C2_CCSA_BA1' }).check();
    await page.getByRole('checkbox', { name: 'C2_CCSA_BA2' }).check();
    await page.getByRole('button', { name: 'move selected left' }).nth(1).click();
    ...
    await page.getByRole('option', { name: 'Basic (C2ConcurrentSimpleWF)' }).click();
    await page.getByRole('option', { name: 'Basic (C2ConcurrentSimpleWF)' }).click();
    ...
    await page.getByRole('option', { name: 'C2 Auditor' }).click();
    ...
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('combobox', { name: 'Role C2 Auditor' }).click();
    await page.getByRole('option', { name: 'C2 Auditee' }).click();
    ...
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('combobox', { name: 'Role C2 Auditee' }).click();
    await page.getByRole('option', { name: 'C2 Auditor' }).click();
    await page.locator('tr:nth-child(2) > td:nth-child(14) > .MuiSvgIcon-root').click();
    ...
    await page.locator('tr:nth-child(8) > td:nth-child(14) > .MuiSvgIcon-root').click();
    await page.getByRole('button', { name: 'Submit' }).click();
    await page.getByRole('combobox', { name: 'Role C2OrgAdmin' }).click();
    await page.getByRole('option', { name: 'C2 Auditee' }).click();
    ...
    await page.getByRole('textbox', { name: 'Audit Name' }).fill('C2 Concurrent Simple JAN 2025');
    ...
    await page.getByRole('option', { name: 'c2admin-C2OrgAdmin' }).click();
    await page.getByRole('combobox', { name: 'Select User' }).nth(1).click();
    await page.getByRole('option', { name: 'c2auditee1-C2 Auditee' }).click();
    await page.getByRole('combobox', { name: 'Select User' }).nth(2).click();
    await page.getByRole('option', { name: 'c2auditor1-C2 Auditor' }).click();
